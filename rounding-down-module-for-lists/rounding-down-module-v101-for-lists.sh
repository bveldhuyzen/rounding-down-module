...
#2. The numerical value (decimal(s)) to which [1] has to be rounded down to is obtained; the module will round down to the nearest (multiple of) this specified numerical value (decimal(s)) // see line 37-38
