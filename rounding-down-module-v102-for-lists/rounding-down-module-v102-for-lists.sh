...
#
#1. The number (from list) that is to be rounded down becomes a variable; this is called the FULL_NUMBER // see line 23
#2. The decimals to which [1] has to be rounded down to are obtained from the echo; the module will round down to the nearest (multiple of) these specified decimals // see line 25
